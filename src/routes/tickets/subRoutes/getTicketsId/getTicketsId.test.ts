    ...
    describe('GET', () => {
      describe('should return status 200 and', () => {
        ...
        it('and return ticket with user\'s profile picture', async () => {
          ...
          expect(currentProfilePicture.cropedImage.format).toBeTruthy();
          expect(currentProfilePicture.cropedImage.height).toBeTruthy();
          expect(currentProfilePicture.cropedImage.id).toBeUndefined();
          expect(currentProfilePicture.cropedImage.signedUrl).toBeTruthy();
          expect(currentProfilePicture.cropedImage.size).toBeTruthy();
          expect(currentProfilePicture.cropedImage.updatedAt).toBeUndefined();
          expect(currentProfilePicture.cropedImage.width).toBeTruthy();
          ...
          expect(currentProfilePicture.originalImage.format).toBeTruthy();
          expect(currentProfilePicture.originalImage.height).toBeTruthy();
          ...
          expect(currentProfilePicture.originalImage.size).toBeTruthy();
          expect(currentProfilePicture.originalImage.updatedAt).toBeUndefined();
          expect(currentProfilePicture.originalImage.width).toBeTruthy();
          ...
          expect(currentProfilePicture.pendingImage.format).toBeTruthy();
          expect(currentProfilePicture.pendingImage.height).toBeTruthy();
          expect(currentProfilePicture.pendingImage.id).toBeUndefined();
          expect(currentProfilePicture.pendingImage.signedUrl).toBeTruthy();
          expect(currentProfilePicture.pendingImage.size).toBeTruthy();
          expect(currentProfilePicture.pendingImage.updatedAt).toBeUndefined();
          expect(currentProfilePicture.pendingImage.width).toBeTruthy();
